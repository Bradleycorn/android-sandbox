...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public static final String ACTION_PAUSE = "net.bradball.android.sandbox.pause";
    public static final String ACTION_PLAY = "net.bradball.android.sandbox.play";
    public static final String ACTION_PREV = "net.bradball.android.sandbox.prev";
    public static final String ACTION_NEXT = "net.bradball.android.sandbox.next";
    public static final String ACTION_STOP_CASTING = "net.bradball.android.sandbox.stop_cast";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case ACTION_STOP_CASTING:
                ...
                i.setAction(MusicService.INTENT_ACTION_PLAYER_COMMAND);
